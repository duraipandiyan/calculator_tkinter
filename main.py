...
btndiv = Button(btnframe, text=chr(247), bd=3, bg="gray", width=12, height=2, fg="black", activebackground="blue",
                command=div)
...
btn1 = Button(btnframe, text="1", bd=3, bg="#4B5320", width=12, height=2, fg="black", activebackground="blue",
              command=lambda: btnclck(1))
btn1.grid(row=1, column=0)

btn2 = Button(btnframe, text="2", bd=3, bg="#4B5320", width=12, height=2, fg="black", activebackground="blue",
              command=lambda: btnclck(2))
btn2.grid(row=1, column=1)

btn3 = Button(btnframe, text="3", bd=3, bg="#4B5320", width=12, height=2, fg="black", activebackground="blue",
              command=lambda: btnclck(3))
btn3.grid(row=1, column=2)

btn4 = Button(btnframe, text="4", bd=3, bg="#4B5320", width=12, height=2, fg="black", activebackground="blue",
              command=lambda: btnclck(4))
btn4.grid(row=2, column=0)

btn5 = Button(btnframe, text="5", bd=3, bg="#4B5320", width=12, height=2, fg="black", activebackground="blue",
              command=lambda: btnclck(5))
btn5.grid(row=2, column=1)

btn6 = Button(btnframe, text="6", bd=3, bg="#4B5320", width=12, height=2, fg="black", activebackground="blue",
              command=lambda: btnclck(6))
btn6.grid(row=2, column=2)

btn7 = Button(btnframe, text="7", bd=3, bg="#4B5320", width=12, height=2, fg="black", activebackground="blue",
              command=lambda: btnclck(7))
btn7.grid(row=3, column=0)

btn8 = Button(btnframe, text="8", bd=3, bg="#4B5320", width=12, height=2, fg="black", activebackground="blue",
              command=lambda: btnclck(8))
btn8.grid(row=3, column=1)

btn9 = Button(btnframe, text="9", bd=3, bg="#4B5320", width=12, height=2, fg="black", activebackground="blue",
              command=lambda: btnclck(9))
btn9.grid(row=3, column=2)

btn0 = Button(btnframe, text="0", bd=3, bg="#4B5320", width=12, height=2, fg="black", activebackground="blue",
              command=lambda: btnclck(0))
...
btncos = Button(btnframe, text="cosθ", bd=3, bg="#C19A6B", width=12, height=2, fg="black", activebackground="blue",
                command=coss)
